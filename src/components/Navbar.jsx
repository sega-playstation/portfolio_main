...
import SmoothTypewriter from "./SmoothTypewriter"; // Your typewriter component
...
export default function Navbar() {
  ...
  // Example style for offset shadow on icons
  const offsetShadow = { boxShadow: "8px 8px 0 #535253" };
  ...
  return (
    <nav className="fixed top-0 left-0 w-full z-50 bg-primaryBg bg-opacity-90 backdrop-blur-md">
      {/* Full-width wrapper with custom horizontal padding */}
